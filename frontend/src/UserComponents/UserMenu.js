...
const UserMenu = (props) => {
    ...
    const search = async() => {
        let apicall = await fetch("http://localhost:3000/Literatures",{
            method: "get",
    ...
    return(
        <div className="UserMenuBox">
            <div className="UserMenuHeader">
                <h5 className="UserMenuPageTitle">Search Page</h5>
                <div className="UserMenuInputBox">
                    <input className="UserMenuInput" type="text" value={input} onChange={(e) => InputChanged(e.target.value)} placeholder="Search Literatures Here..."/>
                </div>
                <div className="UserMenuProfile">
                    ...
                    (<div className="UserMenuProfileDropdown">
                        <h6 className="UserMenuProfileDownloads">Search</h6>
            ...
            <div className="UserMenuContentBox">
                <div className="UserMenuContent">
                    ...
                    showingLista.map((item,i) =>{
                        return(
                        <UserMenuItem key={i} itemData={item} history={props.history} saveText="Save" />
                        );
                    })
